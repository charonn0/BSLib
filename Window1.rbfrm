...
#tag Events Canvas1
	#tag Event
		Sub Paint(g As Graphics)
		  g.DrawPicture(DefaultIconForFileType("docx", 32), 0, 0)
		End Sub
	#tag EndEvent
#tag EndEvents
...
#tag Events Slider1
	#tag Event
		Sub ValueChanged()
		  Label1.Text = FormatHertz(Me.Value)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events Label1
	#tag Event
		Sub Open()
		  Me.Text = FormatHertz(Slider1.Value)
		End Sub
	#tag EndEvent
#tag EndEvents
#tag Events Slider2
...
#tag Events Label4
	#tag Event
		Sub Open()
		  Me.Text = FormatBytes(6516506106516515165, 16)
		End Sub
	#tag EndEvent
#tag EndEvents
...
#tag Events Canvas3
	#tag Event
		Sub Paint(g As Graphics)
		  If screncap <> Nil Then g.DrawPicture(screncap, 0, 0)
		End Sub
	#tag EndEvent
#tag EndEvents
