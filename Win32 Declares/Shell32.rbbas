...
Protected Module Shell32
	...
	#tag ExternalMethod, Flags = &h0
		Declare Function PathIsSlow Lib "Shell32" Alias "PathIsSlowW" (path As WString, attribs As Integer) As Boolean
	#tag EndExternalMethod
	...
	#tag ExternalMethod, Flags = &h0
		Declare Function PickIconDlg Lib "Shell32" (ParentWindow As Integer, resource As Ptr, resourceLen As Integer, ByRef Index As Integer) As Integer
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h0
		Declare Function ShellAbout Lib "Shell32" Alias "ShellAboutW" (HWND As Integer, msgString As WString, otherStuff As WString, hIcon As Integer) As Boolean
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h0
		Declare Function ShellExecute Lib "Shell32" (HWND As Integer, op As WString, file As WString, params As WString, directory As Integer, cmd As Integer) As Integer
	#tag EndExternalMethod
