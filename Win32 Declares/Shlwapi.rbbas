...
Protected Module Shlwapi
	#tag ExternalMethod, Flags = &h0
		Soft Declare Function AssocIsDangerous Lib "Shlwapi" (FileExtension As WString) As Boolean
	...
	#tag ExternalMethod, Flags = &h0
		Declare Function PathAddBackslash Lib "Shlwapi" Alias "PathAddBackslashW" (thePath As Ptr) As Integer
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h0
		Declare Function PathAppend Lib "Shlwapi" Alias "PathAppendW" (firstHalf As Ptr, secondHalf As Ptr) As Boolean
	#tag EndExternalMethod

	#tag ExternalMethod, Flags = &h0
		Declare Function PathCanonicalize Lib "Shlwapi" Alias "PathCanonicalizeW" (OutBuffer As Ptr, InBuffer As Ptr) As Boolean
	#tag EndExternalMethod
